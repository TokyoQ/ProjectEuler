...
public class Driver {
	...
	public static void main(String[] args) throws Exception {
		...
		double seventh = (double)1/7;
	
		String str3 = String.valueOf(third);
		String str6 = String.valueOf(sixth);
		String str7 = String.valueOf(seventh);
		
		System.out.println(third); System.out.println(str3.length());
		System.out.println(sixth); System.out.println(str6.length());
		System.out.println(seventh); System.out.println(str7.length());
